...
public class FindElementsTests {
    ...
    public void findElementsByTagName() {
        ...
        System.out.println(elements.get(2).getText()); // Используем метод get чтобы вывести данные нужного элемента
...
*/
    ...
    public void findElementsByXpath() {
        ...
        //! //*[contains(@attr,'value')]
        driver.findElement(By.xpath("//input[contains(@id,'city')]")); // начинается с
